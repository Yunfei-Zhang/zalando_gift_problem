...
- Files in `results/` are generated by the AI-drafted code (for example `python -m gift.estimate`). They carry no label of their own, since CSV, JSON and PNG files have no comment syntax. Their origin is recorded in this log (#27, #29, #39).
